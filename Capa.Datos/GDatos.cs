...
namespace Capa.Datos
{
    public abstract class GDatos : Conexion
    {
        ...
        //Obtener listas a partir de un procedimento almacenado
        ////public List<string> Traerlistas(string procedimiento)
        ////{
        ////    var objlista = new List<string>();
        ////    SqlCommand cmd = new SqlCommand(procedimiento, cone);
        ////    return objlista;
        ////}
